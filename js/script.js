        ...
        if (name && emaild && message) {
            $.ajax({
                ...
                success: function(data) {
                    $(".Sucess").show();
                    $(".Sucess").fadeIn(2000);
                    $(".Sucess").html("<i class='fa fa-check'></i> Caro <b>" + name + "</b> Obrigado por sua consulta, responderemos o quanto antes!");
                    $("#Name").val("");
                    $("#Email").val("");
                    $("#Subject").val("");
                    $("#Message").val("");
...
copyTextareaBtn1.addEventListener('click', function(event) {
  var copyTextarea1 = document.querySelector('.js-copytextarea1');
